    ...
    public partial class SistemadelicenciasContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tbRoles>(entity =>
            {
                ...
                entity.HasIndex(e => e.role_Nombre, "UQ__tbRoles__3895D82EE217C03D")
                    .IsUnique();
            ...
            modelBuilder.Entity<tbSolicitantes>(entity =>
            {
                ...
                entity.HasIndex(e => e.soli_Identidad, "UQ__tbSolici__ACE8F0CB473779EF")
                    .IsUnique();
            ...
            modelBuilder.Entity<tbTiposLicencias>(entity =>
            {
                ...
                entity.HasIndex(e => e.tili_Descripcion, "UQ__tbTiposL__F7BA37CA001762BA")
                    .IsUnique();
