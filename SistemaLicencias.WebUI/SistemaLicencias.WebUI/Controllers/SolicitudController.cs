...
namespace SistemaLicencias.WebUI.Controllers
{
    public class SolicitudController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            client.BaseAddress = new Uri(_baseurl + $"api/Usuario/AccesoAPantalla?esAdmin={esAdmin}&role_Id={HttpContext.Session.GetInt32("Rol")}&pant_Id=5");

            var Acceso = await client.GetAsync(_baseurl + $"api/Usuario/AccesoAPantalla?esAdmin={esAdmin}&role_Id={HttpContext.Session.GetInt32("Rol")}&pant_Id=5");
