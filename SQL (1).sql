...
VALUES	('Lionel',	'Messi',	'0309198600998', '10-07-1986', 'M', 1, 1, 'calle y #444',	'88264741',  'leoMessi@gmail.com',			1, 1, 1,NULL, NULL),
		('Ana',		'Garc�a',	'1234567890123', '1990-06-15', 'F', 1, 15,'Calle A #123',	'2233-4455', 'ana.garcia@email.com',		1, 1, 1,NULL, NULL),
		('Juan',	'P�rez',	'0801199901234', '1999-01-08', 'M', 2, 22,'Avenida B #456', '9988-7766', 'juan.perez@email.com',		2, 2, 1,NULL, NULL),
		('Mar�a',	'Fern�ndez','0404199101234', '1991-04-04', 'F', 1, 3, 'Calle C #789',	'3344-5566', 'maria.fernandez@email.com',	1, 3, 1,NULL, NULL),
		('Pedro',	'L�pez',	'1509198801234', '1988-09-15', 'M', 2, 41,'Avenida D #1011','6677-8899', 'pedro.lopez@email.com',		2, 2, 1,NULL, NULL),
		('Sof�a',	'Hern�ndez','2802199601234', '1996-02-28', 'F', 1, 52,'Calle E #1213',	'9900-1122', 'sofia.hernandez@email.com',	1, 1, 1,NULL, NULL),
		('Carlos',	'Guti�rrez','2207198501234', '1985-07-22', 'M', 2, 6, 'Avenida F #1415','5544-3322', 'carlos.gutierrez@email.com',	2, 2, 1,NULL, NULL),
		('Luisa',	'Mart�nez', '0703198101234', '1981-03-07', 'F', 1, 37,'Calle G #1617',	'8877-6655', 'luisa.martinez@email.com',	1, 3, 1,NULL, NULL),
		('Javier',	'D�az',		'2705199401234', '1994-05-27', 'M', 2, 8, 'Avenida H #1819','4455-6677', 'javier.diaz@email.com',		2, 4, 1,NULL, NULL);
