...
('2','0201','Trujillo', '1', 1, GETDATE(), NULL, GETDATE()),
   ...
   ('2','0204','Limon', '1', 1, GETDATE(), NULL, GETDATE()),
   ('2','0205','Saba', '1', 1, GETDATE(), NULL, GETDATE()),
   ('2','0206','Santa Fe', '1', 1, GETDATE(), NULL, GETDATE()),
   ('2','0207','Santa Rosa de Aguan', '1', 1, GETDATE(), NULL, GETDATE()),
...
('7', '0719', 'Trojes', '1', 1, GETDATE(), NULL, GETDATE()),
		...
		('8', '0802', 'Alubarón', '1', 1, GETDATE(), NULL, GETDATE()),
		...
		('13', '1328', 'San Marcos de Caiquén', '1', 1, GETDATE(), NULL, GETDATE()),
		...
		('16', '1606' , 'Concepcién del Norte', '1', 1, GETDATE(), NULL, GETDATE()),
		('16', '1607' , 'Concepcién del Sur', '1', 1, GETDATE(), NULL, GETDATE()),
...
('Daniel',	'Hernéndez','2506199301234', 10,'M', '1993-06-25', '8899-3344','Avenida F #1415', 1, NULL, NULL);
